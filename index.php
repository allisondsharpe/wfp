...
<body>
  ...
  <div id="content">
    <div id="main_content">
      ...
      <p> The Anonymous Aspirer is a foundation for creating and maintaining a primary blog that can be used by anyone for anyone. </p>
      <p>Get started today by creating an account down below or log in to your account above. </p>

      <a href="registration.php"><button class="main-btn" type="button">Get Started</button></a>
    </div>
